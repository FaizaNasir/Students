...
describe('Test the doughnut chart default config', function() {
	...
	it('should return the correct html legend', function() {
		...
		var expectedLegend = '<ul class="mychart-legend"><li><span style="background-color:red"></span>label1</li><li><span style="background-color:teal"></span>label2</li></ul>';
...
describe('Test the polar area chart default config', function() {
	...
	it('should return the correct html legend', function() {
		...
		var expectedLegend = '<ul class="mychart-legend"><li><span style="background-color:red">label1</span></li><li><span style="background-color:teal">label2</span></li></ul>';
